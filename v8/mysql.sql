...
CREATE TABLE IF NOT EXISTS `node` (
  ...
  `user_agent` varchar(32) NOT NULL DEFAULT '' COMMENT 'client version',
  `location` varchar(64) NOT NULL DEFAULT '' COMMENT 'host location',
  `network` varchar(64) NOT NULL DEFAULT '' COMMENT 'network status',
